...
class Converter(tf.Module):
    def __init__(self):
        self.smpl_female = smplfit.tf.SMPL(model_name='smpl', gender='female')
        self.smpl_male = smplfit.tf.SMPL(model_name='smpl', gender='male')
        self.smpl_neutral = smplfit.tf.SMPL(model_name='smpl', gender='neutral')

        self.smplx_female = smplfit.tf.SMPL(model_name='smplx', gender='female')
        self.smplx_male = smplfit.tf.SMPL(model_name='smplx', gender='male')
        self.smplx_neutral = smplfit.tf.SMPL(model_name='smplx', gender='neutral')

        self.smplxlh_female = smplfit.tf.SMPL(model_name='smplxlh', gender='female')
        self.smplxlh_male = smplfit.tf.SMPL(model_name='smplxlh', gender='male')
        self.smplxlh_neutral = smplfit.tf.SMPL(model_name='smplxlh', gender='neutral')

        self.smplh16_female = smplfit.tf.SMPL(model_name='smplh16', gender='female')
        self.smplh16_male = smplfit.tf.SMPL(model_name='smplh16', gender='male')
        self.smplh16_neutral = smplfit.tf.SMPL(model_name='smplh16', gender='neutral')

        self.smplh_female = smplfit.tf.SMPL(model_name='smplh', gender='female')
        self.smplh_male = smplfit.tf.SMPL(model_name='smplh', gender='male')
    ...
    def convert(self, body_model_in, gender_in, body_model_out, gender_out, pose, betas, trans,
        ...
        if (body_model_in == 'smpl' or body_model_in == 'smplh' or body_model_in == 'smplh16') and (
            ...
            verts = self.smpl_verts_to_smplx_verts(res['vertices'])
                ...
                body_model_out == 'smpl' or body_model_out == 'smplh' or body_model_out == 'smplh16'):
